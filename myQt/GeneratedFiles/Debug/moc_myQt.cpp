...
QT_MOC_LITERAL(1, 5, 11), // "wheelsignal"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 12), // "QWheelEvent*"
QT_MOC_LITERAL(4, 31, 5), // "event"
QT_MOC_LITERAL(5, 37, 17), // "Button_ok_clicked"
QT_MOC_LITERAL(6, 55, 10), // "wheelEvent"
QT_MOC_LITERAL(7, 66, 16) // "load_image_Event"

    },
    "myQt\0wheelsignal\0\0QWheelEvent*\0event\0"
    "Button_ok_clicked\0wheelEvent\0"
    "load_image_Event"
};
...
void myQt::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->wheelsignal((*reinterpret_cast< QWheelEvent*(*)>(_a[1]))); break;
        case 1: _t->Button_ok_clicked(); break;
        case 2: _t->wheelEvent((*reinterpret_cast< QWheelEvent*(*)>(_a[1]))); break;
        case 3: _t->load_image_Event(); break;
        default: ;
        }
        ...
        {
            typedef void (myQt::*_t)(QWheelEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myQt::wheelsignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myQt::wheelsignal(QWheelEvent * _t1)
{
